...
def Listas():
    ...
    lista_consultas = requests.get(url='http://127.0.0.1:8000/listar-consultas')
    ...
    lista_especialidades_medicas = requests.get(url='http://127.0.0.1:8000/listar-especialidades-medicas')
    ...
    lista_local_atendimento = requests.get(url='http://127.0.0.1:8000/listar-local-atendimento')
